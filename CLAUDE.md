...
> **Note:** This file is maintained as a copy of [AGENTS.md](./AGENTS.md) for backwards compatibility.
> The canonical documentation is in AGENTS.md. Ideally, this file should be a symlink.
